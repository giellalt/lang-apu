* `src/`
    * `cg3/`
        * [functions.cg3](src-cg3-functions.cg3.html) ([src](https://github.com/giellalt//blob/main/src/cg3/functions.cg3))
    * `fst/`
        * `affixes/`
            ...
            * [adverbs.lexc](src-fst-affixes-adverbs.lexc.html) ([src](https://github.com/giellalt//blob/main/src/fst/affixes/adverbs.lexc))
            * [nouns.lexc](src-fst-affixes-nouns.lexc.html) ([src](https://github.com/giellalt//blob/main/src/fst/affixes/nouns.lexc))
            * [prefixes.lexc](src-fst-affixes-prefixes.lexc.html) ([src](https://github.com/giellalt//blob/main/src/fst/affixes/prefixes.lexc))
            * [pronouns.lexc](src-fst-affixes-pronouns.lexc.html) ([src](https://github.com/giellalt//blob/main/src/fst/affixes/pronouns.lexc))
        ...
        * `stems/`
            ...
            * [exceptions.lexc](src-fst-stems-exceptions.lexc.html) ([src](https://github.com/giellalt//blob/main/src/fst/stems/exceptions.lexc))
            ...
            * [propernouns.lexc](src-fst-stems-propernouns.lexc.html) ([src](https://github.com/giellalt//blob/main/src/fst/stems/propernouns.lexc))
    ...
    * `transcriptions/`
        ...
        * [transcriptor-numbers-digit2text.lexc](src-transcriptions-transcriptor-numbers-digit2text.lexc.html) ([src](https://github.com/giellalt//blob/main/src/transcriptions/transcriptor-numbers-digit2text.lexc))
* `tools/`
    * `grammarcheckers/`
