...
This directory contains source files for the Apurinã language morphology
...
-   <https://giellalt.uit.no/lang/apu/Apurina.html> (the analyser)
-   <https://giellalt.uit.no/index.html> (the infrastructure)
...
The Apurinã language sources can be acquired using [giella SVN
